...
public class Produits {
 ...
 private Image IMAGE2;
  ...
  private ImageView IMAGE5;
    ...
    public Produits(int reference, int quantite, int quantiteR, String rate, String nom, String desc, String type, Date dateP, String CATEGORIE, Double prix, ImageView IMAGE5) {
        this.reference = reference;
        this.quantite = quantite;
        this.quantiteR = quantiteR;
        this.rate = rate;
