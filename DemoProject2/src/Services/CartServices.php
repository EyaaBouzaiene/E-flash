...
class CartServices
{
    ...
    public function __construct(SessionInterface $session, Produit2Repository $repoProduct){
        $this->session = $session;
        $this->repoProduct = $repoProduct;
    }


    public function add(Produit2 $product){
        $panier = $this->getCart();
        $id = $product->getId();
    ...
    public function remove(Produit2 $product){
        $panier = $this->getCart();
        $id = $product->getId();
    ...
    public function removeall(Produit2 $product){
        $panier = $this->getCart();
        $id = $product->getId();
