...
class Publication
{
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="id_client_publication", referencedColumnName="id")
     * })
     */
    ...
    public function getIdClientPublication(): ?User
    {
        return $this->idClientPublication;
    }

    public function setIdClientPublication(?User $idClientPublication): self
    {
