 ...
 * Dislikes
 *
 * @ORM\Table(name="dislikes", indexes={@ORM\Index(name="FK_2DF3BE11916015D1", columns={"id_client_dislike"}), @ORM\Index(name="FK_2DF3BE11B058A65D", columns={"id_publication_dislike"})})
 * @ORM\Entity
 */
class Dislikes
{
