...
class FavorisRepository extends ServiceEntityRepository
{
    ...
    public function listProduitByCat($str){
        return $this->getEntityManager()
        ->createQuery(
            'SELECT prov.id
        FROM App\Entity\Favoris prov WHERE prov.produits =:str'
        )
    ...
    public function listfavoris($str){
        return $this->getEntityManager()
        ->createQuery(
            'SELECT prov
        FROM App\Entity\Favoris prov WHERE prov.user =:str'
        )
        ->setParameter('str',$str)
        ->getResult();
