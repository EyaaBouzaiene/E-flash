...
class CartController extends AbstractController
{
     ...
     */
    public function add(Produits $product,CartServices $cartServices)
    {
...
$cartServices->add($product);
     ...
     */
    public function remove(Produits $product,CartServices $cartServices )
    {
        // On récupère le panier actuel
     ...
     */
    public function delete(Produits $product,CartServices $cartServices)
    {
        // On récupère le panier actuel
 ...
 /**
     ...
     public function checkout($stripeSK,SessionInterface $session,Produit2Repository $productsRepository,CategoriesRepository $classroomRepository,CartServices $cartServices)
     {
