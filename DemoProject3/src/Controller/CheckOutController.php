...
class CheckOutController extends AbstractController
{
     ...
     */
    public function index(Request $request,Categorie2Repository $classroomRepository,Produit2Repository $p): Response
    {
    ...
    //  */
    // public function list3(CategoriesRepository $classroomRepository,$id,ProduitsRepository $p): Response
    // {
      
    //     $classroom=$classroomRepository->findAll();
    //     $classroom3=$classroomRepository->find($id);
    //     $produit=$p->listProduitByCat($classroom3->getCode());
