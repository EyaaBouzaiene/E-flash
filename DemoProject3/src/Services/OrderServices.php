...
class OrderServices{
    ...
    public function __construct(EntityManagerInterface $manager,ProduitsRepository $repoProduct)
    {
    ...
    public function saveCart($data,$user)
    {
        ...
        $cart->setReference($reference)
             ->setTransportName("Ahmed")
             ->setTransportPrice(2.0)
             ->setFullname("Dhia aderssa ")
             ->setLivraisonAdresse("Dhia aderssa ")
             ->setMoreInformations("Dhia aderssa ")
        ...
        foreach ($data['products'] as $products) {
            ...
            ->setProductName($products['product']->getNOM())
        ...
        // foreach ($data['products'] as $products2) {

        //     $quantiteR = $products2['product']->getQuantiter()-$products2['quantity'] ;
        //     $product->setQuantiter($quantiteR);
